//  criar pasta lista servicos dentro da pasta pages 
// criar arquivo index.tsx dentro da pasta lista servicos
// criar arquivo style.css dentro da pasta lista servicos
// importar html para meu arquivo index.tsx da minha pasta lista servicos 
// copiar codigo css para o arquivo style.css da pasta listaservicos 
// importar o css do componente lista servicos dentro do arquivo index.tsx 
...
function ListaServicos() {
    ...
    function mostrarMenu() {
        ...
        let menu = document.getElementById("menu_links") as HTMLElement; // Obtém o elemento do menu pelo ID
        let sombra = document.getElementById("sombra") as HTMLElement; // Obtém o elemento da sombra pelo ID
        let menu_barras = document.getElementById("menu_barras") as HTMLElement; // Obtém o elemento do botão do menu pelo ID
